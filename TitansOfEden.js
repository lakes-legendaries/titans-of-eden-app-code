...
break;}}}
var full_card={setup:function(){},update:function(){},hide:function(){},showing:[-1,-1],showing_subv:null,active:function(){return full_card[0].visible;},}
...
env.background.setInteractive().on('pointerdown',()=>{full_card.hide()});tut.button[0].setInteractive().on('pointerdown',()=>{full_card.hide()});tut.button[1].setInteractive().on('pointerdown',()=>{full_card.hide()});full_card.hide();}
