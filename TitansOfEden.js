...
env.background.setInteractive().on('pointerdown',()=>{full_card.hide()});tut.button[0].setInteractive().on('pointerdown',()=>{full_card.hide()});tut.button[1].setInteractive().on('pointerdown',()=>{full_card.hide()});full_card.hide();full_card.game_over=true;}
